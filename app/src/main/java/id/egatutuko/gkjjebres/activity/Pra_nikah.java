...
public class Pra_nikah extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.pilih_tanggal2).setOnClickListener(new View.OnClickListener(){
            public void onClick (View v){
                showDatePickerDialog();
            }
        });
        findViewById(R.id.pilih_tanggal3).setOnClickListener(new View.OnClickListener(){
            public void onClick (View v){
                showDatePickerDialog();
            }
        });
