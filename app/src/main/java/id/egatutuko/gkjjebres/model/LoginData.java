...
public class LoginData {
	...
	private String alamatGereja;

	@SerializedName("kelompok gereja")
	private String kelompokGereja;
	...
	public void setAlamatGereja(String alamatGereja){
		this.alamatGereja = alamatGereja;
	}

	public String getAlamatGereja(){
		return alamatGereja;
	}

	public void setKelompokGereja(String kelompokGereja){
		this.kelompokGereja = kelompokGereja;
	}

	public String getKelompokGereja(){
