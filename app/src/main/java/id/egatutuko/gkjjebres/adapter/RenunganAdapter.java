...
public class RenunganAdapter extends RecyclerView.Adapter<RenunganAdapter.RecyclerViewHolder> {
    ...
    private final ArrayList<RecyclerDataRenungan> dataList;
    private final Context context;

    public RenunganAdapter(ArrayList<RecyclerDataRenungan> recyclerDataArrayList, Context context){
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        RecyclerDataRenungan recyclerData = dataList.get(position);
