...
public class DPFragmentBaptisAnak extends DialogFragment
        implements DatePickerDialog.OnDateSetListener {
    // This is the listener for the activity
    private DPFragmentListenerAnak listener;
    ...
    public interface DPFragmentListenerAnak {
    ...
    public void onAttach(Context context){
        ...
        listener = (DPFragmentListenerAnak) context;
    }
}
